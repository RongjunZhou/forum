...
/*!40000 ALTER TABLE `comment`
    DISABLE KEYS */;
INSERT INTO `comment`
VALUES (1, 1, 1, '1', 1, 1, '2023-11-01 23:27:14'),
       (2, 1, 1, '1', 1, 1, '2023-11-01 23:27:40');
/*!40000 ALTER TABLE `comment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `post_info`
    DISABLE KEYS */;
INSERT INTO `post_info`
VALUES (1, 1, 1, '1', '1', '1', '2023-11-01 23:19:32');
/*!40000 ALTER TABLE `post_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `view_history`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `view_history`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50001 CREATE ALGORITHM = UNDEFINED */ /*!50013 DEFINER =`root`@`localhost` SQL SECURITY DEFINER */ /*!50001 VIEW `post` AS
select `post_info`.`id`         AS `id`,
       `post_info`.`user_id`    AS `user_id`,
       `post_info`.`plate_id`   AS `plate_id`,
       `post_info`.`title`      AS `title`,
       `post_info`.`content`    AS `content`,
       `post_info`.`resources`  AS `resources`,
       `post_info`.`createTime` AS `createTime`,
